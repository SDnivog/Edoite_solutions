            ...
            <div class="container">
                <div class="row">
                    <div class="col-xxl-6 col-md-7">
                        <h1 class="hero-heading">Customer Ai Solution for user <span>Analystics.</span></h1>
                        ...
                        <ul class="style-none button-group d-flex align-items-center">
                            <li class="me-4"><a href="contact-us" class="demo-btn ripple-btn tran3s">Request A Demo</a></li>
            ...
            <div class="container">
                <div class="row align-items-center">
                    ...
                    <div class="col-xl-6 col-lg-7" data-aos="fade-left">
                        <p class="m0 text-center text-lg-start md-pt-30">NLP entails applying algorithms to identify and extract rules such that the unstructured language data is converted.</p>
                    </div>
                </div>
                ...
                <div class="row justify-content-center pt-30">
                    <div class="col-lg-4 col-md-6" data-aos="fade-right">
                        <div class="block-style-twelve mt-30 ps-lg-0 pe-xl-5 me-xl-2">
                            ...
                            <h5><a href="service-details-V1">Data Science</a></h5>
                            <p>Convert data noise intelligent insights for competitive differentiation qulaity check equlity.</p>
                            <a href="service-details-V1" class="tran3s more-btn"><img src="images/icon/icon_20.svg" alt=""></a>
                        </div>
                        <!-- /.block-style-twelve -->
                    </div>
                    <!-- /.item -->
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="100">
                        <div class="block-style-twelve mt-30 active">
                            ...
                            <h5><a href="service-details-V1">Customer Support</a></h5>
                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-left">
                        <div class="block-style-twelve mt-30">
                            ...
                            <h5><a href="service-details-V1">Machine Learning</a></h5>
                            <p>Convert data noise intelligent insights for competitive differentiation qulaity check equlity.</p>
                            <a href="service-details-V1" class="tran3s more-btn"><img src="images/icon/icon_20.svg" alt=""></a>
                        </div>
                        <!-- /.block-style-twelve -->
                ...
                <div class="row">
                    <div class="col-xl-5 col-lg-6 col-md-7 ms-auto">
                        <div class="block-style-two" data-aos="fade-left">
                            ...
                            <!-- /.title-style-three -->
                            <p class="pt-20 pb-25 lg-pb-20">AI technology is perfect for best business solutions & we offer help to achieve your goals.</p>
                            ...
                            <a href="about-us2" class="btn-eight mt-50 lg-mt-30">More about us</a>
                        </div>
                        <!-- /.block-style-two -->
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col-lg-5">
                        <div class="block-style-five pe-xxl-5 me-xxl-5 md-pb-50" data-aos="fade-right">
                            ...
                            <a href="contact-us" class="btn-eight ripple-btn">Contact us</a>
                        </div>
                        <!-- /.block-style-five -->
                    </div>
                ...
                <div class="row gx-xxl-5">
                    <div class="col-lg-4 col-sm-6 d-flex" data-aos="fade-up">
                        <article class="blog-meta-one color-two tran3s mt-30">
                            <figure class="post-img m0"><a href="blog-details" class="w-100 d-block"><img src="images/blog/blog_img_01.jpg" alt="" class="w-100 tran4s"></a></figure>
                            <div class="post-data">
                                <div class="post-tag"><a href="blog-details">Data Science</a> - 15 minute read</div>
                                <a href="blog-details" class="blog-title">
                    ...
                    <div class="col-lg-4 col-sm-6 d-flex" data-aos="fade-up" data-aos-delay="100">
                        <article class="blog-meta-one color-two tran3s mt-30">
                            <figure class="post-img m0"><a href="blog-details" class="w-100 d-block"><img src="images/blog/blog_img_02.jpg" alt="" class="w-100 tran4s"></a></figure>
                            <div class="post-data">
                                <div class="post-tag"><a href="blog-details">UI/UX Design</a> - 10 minute read</div>
                                <a href="blog-details" class="blog-title">
                    ...
                    <div class="col-lg-4 col-sm-6 d-flex" data-aos="fade-up" data-aos-delay="200">
                        <article class="blog-meta-one color-two tran3s mt-30">
                            <figure class="post-img m0"><a href="blog-details" class="w-100 d-block"><img src="images/blog/blog_img_03.jpg" alt="" class="w-100 tran4s"></a></figure>
                            <div class="post-data">
                                <div class="post-tag"><a href="blog-details">Marketing</a> - 8 minute read</div>
                                <a href="blog-details" class="blog-title">
