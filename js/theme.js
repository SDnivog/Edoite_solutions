(function(a) {
    a("body").length && a("body").append('<a href="https://html.creativegigstf.com/sinco/dark" id="switcher" class="d-flex align-items-center justify-content-center" title="Dark Mood"><i class="bi bi-moon-stars-fill"></i></a>');
